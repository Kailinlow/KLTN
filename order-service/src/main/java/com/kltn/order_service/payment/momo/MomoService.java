...
public class MomoService {
    ...
    public MomoResponse createPaymentRequest(String amount) {
        try {
            // Tạo request giống như ban đầu
            ...
            try (CloseableHttpResponse response = httpClient.execute(httpPost)) {
                ...
                // Chuyển đổi JSON sang DTO
                ObjectMapper objectMapper = new ObjectMapper();
                return objectMapper.readValue(result.toString(), MomoResponse.class);
            }
        } catch (Exception e) {
            e.printStackTrace();
            return null;
